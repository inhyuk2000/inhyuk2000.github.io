...
### 프로젝트를 진행하며 느낀점
여러 프로젝트를 진행하며 "직접 써보기 전에는 문제 상황을 찾아내지 못한다." 라는 생각을 하게 되어, 뉴런 해석 관련 기존 논문의 Github 자료를 직접 설치해 사용해보면서 문제 상황을 파악하려고 노력했습니다. 여러 번 기획을 갈아엎는 경험을 해 본 덕에, 이 프로젝트에서는 기획 부분에서 저의 노력이 많이 들어가 뿌듯한 생각이 들었습니다. 이후 딥러닝 프로젝트 담당 교수님과의 주기적인 회의를 통해, 연구의 방향성을 지속적으로 수정해보며 연구 방향을 위한 인사이트를 얻을 수 있었습니다. 결국 단일 뉴런 중심 해석이 아닌 여러 뉴런들의 공통 활성화 패턴을 가지고 집합 자체를 뉴런 해석에 사용해보자는 새로운 아이디어가 떠올라 성공적으로 연구를 마치고, KCC 2025 학회에 제출까지 할 수 있었습니다. 감사하게도 장려상을 수상하게 되어 그동안의 노력이 보상받는 느낌이었습니다.