...
### 프로젝트를 진행하며 느낀점
일상 속에서 문제를 발견하고 이를 해결하기 위한 실용적인 연구를 진행하는 것은 매우 재미있었고, 컴퓨터 공학으로 전과를 했었던 근본적인 이유였습니다. 하지만 이러한 문제를 구체화하고 기존의 다른 연구와의 차별점을 갖기란 너무 어려웠습니다. 이로 인해 기획 단계에서 상당히 많은 시간을 쏟으며 연구 주제를 갈아엎기를 반복했었던 것 같습니다. Xmind를 활용해 연구 주제 탐색의 깊이를 더하는 훈련을 반복해서 하다보니, 자연스레 기획 능력이 향상되었고 그 기획의 중요성에 대해서 더욱 깊이 느낄 수 있었던 시간이었습니다. 처음 연구를 진행하고 해당 연구를 논문화하여 최우수상이라는 값진 경험을 얻을 수 있었지만, 이런 결과는 저 혼자만이 아닌 교수님과 같이 논문 작성에 힘을 보태주셨던 선배분의 도움이 컸던 것 같습니다.