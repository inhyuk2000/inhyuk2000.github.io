...
### 서비스 디자인
Figma를 활용해 실제 서비스에 가까운 수준으로 UI/UX를 디자인했습니다. 화면을 구성할 때는 사용성을 고려해 버튼과 텍스트의 배치를 설계하고, 사용자에게 어떤 정보를 효과적으로 제공할지 중점적으로 고민했습니다. {{% high_mark %}}**[1] 특히 알림 피로가 얼마나 줄어들었는지 사용자가 직접 확인할 수 있도록 차단된 알림의 실시간 통계 기능을 추가**{{% /high_mark %}}했습니다. 또한 필요한 경우 {{% high_mark %}}**[2] 모든 알림을 한 번에 확인할 수 있는 버튼을 제공**{{% /high_mark %}}하고, 홈 화면 하단에서는 {{% high_mark %}}**[3] 수신된 알림을 앱별로 요약**{{% /high_mark %}}해 확인할 수 있도록 구성했습니다.
